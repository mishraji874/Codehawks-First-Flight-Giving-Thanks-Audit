...
contract GivingThanks is ERC721URIStorage {
    ...
    // @audit-high criitical initializatiion vulnerability
    ...
    // @audit-high Missing Input Validation for Donation Amount
    ...
    // @audit-medium iinadequate token uri security
    ...
    // @audit-high unprotected registry update
